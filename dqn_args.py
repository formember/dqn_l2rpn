...
# parser.add_argument("--taskstr", default="dm_control,cartpole_balance")
parser.add_argument("--taskstr", default="rte_case14_realistic")
...
parser.add_argument("--pre_step", default=64, type=int)
...
parser.add_argument("--replay_table_max_replay_size", default=20000, type=int)
...
parser.add_argument("--quantize", type=int, choices=[8,16,32], default=8)
...
parser.add_argument("--min_replay_size", type=int, default=1)
